          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className={"form-group form-group-default required"+(_validations.gasPrice?"":" has-error")}>
                ...
                <input type="number" placeholder="Enter Gas Price" value={scheduleStore.gasPrice}  onBlur={this.validate('gasPrice')} onChange={this.onChange('gasPrice')}  className="form-control"></input>
              </div>
