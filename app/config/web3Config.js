import mainnetDAYTokenABI from '../abi/mainnetDAYTokenABI';

import testnetDAYFaucetABI from '../abi/testnetDAYFaucetABI';
import testnetDAYTokenABI from '../abi/testnetDAYTokenABI';
...
const Networks = {
  ...
  1: {
    ...
    dayTokenAbi: mainnetDAYTokenABI,
    supported: true,
  ...
  3: {
    ...
    dayTokenAbi: testnetDAYTokenABI,
