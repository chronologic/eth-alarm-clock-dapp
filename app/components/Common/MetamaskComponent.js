...
class MetamaskComponent extends Component {
    ...
    */
    ...
    if (!hasPreviousMetamaskState || hasChangedMetamaskState) {
      if (metamaskInstalled) {
        ...
        showNotification(
          `<b>Metamask</b> is required to use this Dapp <a href='https://metamask.io' target='_blank' >https://metamask.io</a>`,
          'warning'
        );
      }
  ...
  async scoutUpdates() {
    ...
    const accountsChanged =
      (this.state.accounts && this.state.accounts.length) !== (web3Service.accounts !== null && web3Service.accounts.length) ||
